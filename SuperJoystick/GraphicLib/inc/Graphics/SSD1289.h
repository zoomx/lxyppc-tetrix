 ...
 *  Solomon Systech. SSD1289 LCD controllers driver
 *****************************************************************************
 * FileName:        SSD1289.h
...
#else
#define WriteData(data) RS_LAT_BIT=1;PMDIN1=((WORD_VAL)(WORD)data).v[1];PMPWaitBusy();PMDIN1=((WORD_VAL)(WORD)data).v[0];PMPWaitBusy();
#endif
/*********************************************************************
...
SetIndex(0x4E);WriteData(x);\
SetIndex(0x4F);WriteData(y);\
SetIndex(0x22);
