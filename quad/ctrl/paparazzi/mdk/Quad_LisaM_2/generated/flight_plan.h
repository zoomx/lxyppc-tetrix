/* This file has been generated from /home/iwow/work/paparazzi/paparazzi/conf/flight_plans/rotorcraft_basic.xml */
/* Please DO NOT EDIT */
...
static inline void auto_nav(void) {
  switch (nav_block) {
    ...
    Block(4) // Takeoff
    ; // pre_call
    if ((nav_block != 5) && (ins_enu_pos.z>POS_BFP_OF_REAL(2.000000))) { GotoBlock(5); return; }
    switch(nav_stage) {
      Stage(0)
