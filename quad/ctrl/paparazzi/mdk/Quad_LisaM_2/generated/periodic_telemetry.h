/* This file has been generated from /home/iwow/work/paparazzi/paparazzi/conf/messages.xml and /home/iwow/work/paparazzi/paparazzi/conf/telemetry/default_rotorcraft.xml */
/* Please DO NOT EDIT */
...
#define PERIOD_BOOZ2_CAM_Main_0 (1.)
#define PERIOD_GPS_INT_Main_0 (.25)
#define PERIOD_INS_Main_0 (.25)
#define PERIOD_I2C_ERRORS_Main_0 (6.)
...
#define PERIOD_STAB_ATTITUDE_Main_9 (.4)
...
#define PeriodicSendMain(_trans, _dev) {  /* 60Hz */ \
  if (telemetry_mode_Main == TELEMETRY_MODE_Main_default) {\
    ...
    if (i60 == 18) {\
      PERIODIC_SEND_BOOZ2_CAM(_trans, _dev);\
    } \
    if (i66 == 24) {\
