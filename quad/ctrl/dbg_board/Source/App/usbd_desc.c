...
#define USBD_VID                     0x0250
#define USBD_PID                     0x0250

#define USBD_LANGID_STRING            0x409
#define USBD_MANUFACTURER_STRING      "lxyppc"

#define USBD_PRODUCT_HS_STRING        "BLDC Tester"
#define USBD_SERIALNUMBER_HS_STRING   "00000000011B"

#define USBD_PRODUCT_FS_STRING        "BLDC Tester"
