...
void system_init(void);       /**< Initialise the timers, ports, interupts, etc */
void device_boot_msg(void);   /**< Runs a LED pattern to indicate startup */
void delay_10ms(void);        /**< Delay of aprox 10ms */
void delay_100ms(void);       /**< Delay of aprox 100ms */
